...
public class Typhoid_Extra_Master_DataModel{
    ...
    private String SaveData(Context context)
    {
        ...
        try
        {
            SQL = "Insert into "+ TableName +" (Upazila,UpName,UNCode,Uname,VCode,Vname,Cluster,StructureNo,HouseholdSl,VisitNo,MemSl,HHHead,childName,Age,Sex,Father,Mother,Holding,Road,Address,VisitDate,StartTime,EndTime,DeviceID,EntryUser,Lat,Lon,EnDt,Upload,modifyDate)Values('"+ _Upazila +"', '"+ _UpName +"', '"+ _UNCode +"', '"+ _Uname +"', '"+ _VCode +"', '"+ _Vname +"', '"+ _Cluster +"', '"+ _StructureNo +"', '"+ _HouseholdSl +"', '"+ _VisitNo +"', '"+ _MemSl +"', '"+ _HHHead +"', '"+ _childName +"', '"+ _Age +"', '"+ _Sex +"', '"+ _Father +"', '"+ _Mother +"', '"+ _Holding +"', '"+ _Road +"', '"+ _Address +"', '"+ _VisitDate +"', '"+ _StartTime +"', '"+ _EndTime +"', '"+ _DeviceID +"', '"+ _EntryUser +"', '"+ _Lat +"', '"+ _Lon +"', '"+ _EnDt +"', '"+ _Upload +"', '"+ _modifyDate +"')";
