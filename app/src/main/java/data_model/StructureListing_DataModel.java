...
import android.content.Context;
 ...
 public class StructureListing_DataModel{
        ...
        public String SaveUpdateData(Context context)
        {
            ...
            try
            {
                 if(C.Existence("Select * from "+ TableName +"  Where Upazila='"+ _Upazila +"' and UNCode='"+ _UNCode +"' "))
