 ...
 public class StructureListing_DataModel{
     ...
     String TableName = "StructureListing";
        ...
        public String SaveUpdateData(Context context)
        {
            ...
            try
            {
                 if(C.Existence("Select * from "+ TableName +"  Where Upazila='"+ _Upazila +"' and UNCode='"+ _UNCode +"' and vcode='"+_VCode+"' and Cluster='"+_Cluster+"' and StructureNo='"+_StructureNo+"' and DeviceID='"+_DeviceID+"'"))
