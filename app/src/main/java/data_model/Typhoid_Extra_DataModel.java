...
public class Typhoid_Extra_DataModel{
    ...
    private String SaveData(Context context)
    {
        ...
        try
        {
            SQL = "Insert into "+ TableName +" (UNCode,StructureNo,HouseholdSl,VisitNo,MemSl,HaveHosp,HospName,HospName_Oth,HaveRecords,DidRecordMatch2,DaysOfHosp,DaysOfHospDK,Phone,TAboIll,StartTime,EndTime,DeviceID,EntryUser,Lat,Lon,EnDt,Upload,modifyDate)Values('"+ _UNCode +"', '"+ _StructureNo +"', '"+ _HouseholdSl +"', '"+ _VisitNo +"', '"+ _MemSl +"', '"+ _HaveHosp +"', '"+ _HospName +"', '"+ _HospName_Oth +"', '"+ _HaveRecords +"', '"+ _DidRecordMatch2 +"', '"+ _DaysOfHosp +"', '"+ _DaysOfHospDK +"', '"+ _Phone +"', '"+ _TAboIll +"', '"+ _StartTime +"', '"+ _EndTime +"', '"+ _DeviceID +"', '"+ _EntryUser +"', '"+ _Lat +"', '"+ _Lon +"', '"+ _EnDt +"', '"+ _Upload +"', '"+ _modifyDate +"')";
    ...
    private String UpdateData(Context context)
    {
        ...
        try
        {
            SQL = "Update "+ TableName +" Set Upload='2',modifyDate='" + _modifyDate + "' ,UNCode = '"+ _UNCode +"',StructureNo = '"+ _StructureNo +"',HouseholdSl = '"+ _HouseholdSl +"',VisitNo = '"+ _VisitNo +"',MemSl = '"+ _MemSl +"',HaveHosp = '"+ _HaveHosp +"',HospName = '"+ _HospName +"',HospName_Oth = '"+ _HospName_Oth +"',HaveRecords = '"+ _HaveRecords +"',DidRecordMatch2 = '"+ _DidRecordMatch2 +"',DaysOfHosp = '"+ _DaysOfHosp +"',DaysOfHospDK = '"+ _DaysOfHospDK +"',Phone = '"+ _Phone +"',TAboIll = '"+ _TAboIll +"'  Where UNCode='"+ _UNCode +"' and StructureNo='"+ _StructureNo +"' and HouseholdSl='"+ _HouseholdSl +"' and VisitNo='"+ _VisitNo +"' and MemSl='"+ _MemSl +"' and DeviceID='"+_DeviceID+"'";
            response = C.SaveData(SQL);
            C.close();
        }
        catch(Exception  e)
    ...
    public List<Typhoid_Extra_DataModel> SelectAll(Context context, String SQL)
    {
        ...
        while(!cur.isAfterLast())
        {
            ...
            d._Phone = cur.getString(cur.getColumnIndex("Phone"));
