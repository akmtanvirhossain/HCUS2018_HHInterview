...
public class OtitisMediaCase1_DataModel {
       ...
       String TableName = "OtitisMediaCase1";
       ...
       public List<OtitisMediaCase1_DataModel> SelectAll(Context context, String SQL)
       {
           Connection C = new Connection(context);
           List<OtitisMediaCase1_DataModel> data = new ArrayList<OtitisMediaCase1_DataModel>();
           OtitisMediaCase1_DataModel d = new OtitisMediaCase1_DataModel();
           Cursor cur = C.ReadData(SQL);

           cur.moveToFirst();
           while(!cur.isAfterLast())
           {
               d = new OtitisMediaCase1_DataModel();
